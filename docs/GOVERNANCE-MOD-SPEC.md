...
> [`docs/GOVERNANCE-MOD-SPEC.md`](https://github.com/theasshats/project-commonwealth/blob/main/docs/GOVERNANCE-MOD-SPEC.md)
...
> them, only `GOVERNANCE-REALMS-SCOPE.md` is also mirrored locally).
